...
A simple REST API that manages invoices.
 ...
 It contains the code and
 to the basic setup of the invoicer application and
infrastructure, plus the improvements implemented for ZAP security scan.
...
```bash
$ docker run -it <MyGitHubUser>/invoicer-go2
```
